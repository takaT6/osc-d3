<template>
  ...
  <div id="accordion-collapse" data-accordion="collapse">
    ...
    <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">  
      <div class="option-area justify-center p-5 font-light border border-t-0 border-gray-200 dark:border-gray-700">
        <div class="flex justify-center">
          <input :class="TW.INPUT" class="" type="number" v-model="chartUtil.marklineVal.value" style="width: 16vw;">
        </div>
        <div class="flex justify-center flex-row">
          <label :class="TW.LABEL">Min</label>
          <input :class="TW.INPUT" id="y-axis-min" type="number" v-model="chartUtil.yAxis.min" style="width: 14vw;">
          ...
          <input :class="TW.INPUT" id="y-axis-max" type="number" v-model="chartUtil.yAxis.max" style="width: 14vw;">
    ...
    <div id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
      <div class="option-area p-5 font-light border border-t-0 border-gray-200 dark:border-gray-700">
        <div class="flex justify-center flex-row">
          <div class="w-1/6 md:w-1/3 px-3 mb-6 md:mb-0" style="width: 17vw;">
...
import { Const, TW } from '@/script/common';
